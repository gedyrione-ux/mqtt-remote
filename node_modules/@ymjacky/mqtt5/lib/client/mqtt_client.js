...
import { BaseMqttClient } from "./base_mqtt_client.js";
import * as MqttStream from "../mqtt_stream_utils/mod.js";
import { ConnectionClosed, ConnectionReset, UnexpectedUrlProtocol } from "./error.js";
// curry: generate write function
const writerFactory = (conn, log)=>{
 ...
 */ export class MqttClient extends BaseMqttClient {
   ...
   */ async handleMalformedPacket(_rawBytes, error) {
    try {
