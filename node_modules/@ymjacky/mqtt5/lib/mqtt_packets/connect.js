import { numToQoS, numToTwoByteInteger, numToVariableByteInteger, stringToUtfEncodedString, twoByteIntegerToNum, utfEncodedStringToString, variableByteIntegerToNum } from "../mqtt_utils/mod.js";
import * as Mqtt from "../mqtt/mod.js";
import * as MqttProperties from "../mqtt_properties/mod.js";
import { InvalidProtocolVersionError } from "./error.js";
export function toBytes(packet) {
...
export function parse(buffer, _remainingLength) {
  let pos = 0;
  ...
  if (protocolVersion != Mqtt.ProtocolVersion.MQTT_V3_1_1 && protocolVersion != Mqtt.ProtocolVersion.MQTT_V5) {
