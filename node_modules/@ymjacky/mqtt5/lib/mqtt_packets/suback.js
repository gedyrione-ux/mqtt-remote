...
export function toBytes(packet, protocolVersion) {
  ...
  const payload = protocolVersion > Mqtt.ProtocolVersion.MQTT_V3_1_1 ? packet.reasonCodes : packet.returnCodes;
  const fixedHeader = [
...
//# sourceMappingURL=suback.js.map