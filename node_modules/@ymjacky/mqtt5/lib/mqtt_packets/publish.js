...
import { numToQoS, numToTwoByteInteger, numToVariableByteInteger, stringToBytes, stringToUtfEncodedString, twoByteIntegerToNum, utfEncodedStringToString, variableByteIntegerToNum } from "../mqtt_utils/mod.js";
...
export function toBytes(packet, protocolVersion) {
  ...
  const flags = (packet.dup ? 0b1000 : 0) + // dup
  (qos << 1) + // qos
...
export function parse(packetFlags, buffer, remainingLength, protocolVersion) {
  // fixed header
